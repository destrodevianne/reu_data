...
public class GludioBloodAltar extends Quest
{
	...
	public GludioBloodAltar(int questId, String name, String descr)
	{
		...
		ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
		{
			...
			public void run()
			{
				GludioBloodAltar.this.changestatus();
			}
		}, delay);
	}
	...
	protected void changestatus()
	{
		ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
		{
			...
			public void run()
			{
				...
				{
					GludioBloodAltar.this.manageNpcs(false);
					GludioBloodAltar.this.manageBosses(true);
				}
				else
				{
					GludioBloodAltar.this.manageBosses(false);
					GludioBloodAltar.this.manageNpcs(true);
					ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
					{
						@Override
						public void run()
