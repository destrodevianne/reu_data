...
public class ErosionA extends Quest
{
	...
	public ErosionA(int questId, String name, String descr)
	{
	...
	{
		new ErosionA(-1, ErosionA.class.getSimpleName(), "instances");
	}
}