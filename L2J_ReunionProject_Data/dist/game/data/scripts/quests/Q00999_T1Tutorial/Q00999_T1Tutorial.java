...
public class Q00999_T1Tutorial extends Quest
{
	...
	private static final L2TIntObjectHashMap<Talk> Talks = new L2TIntObjectHashMap<>();
	...
	public Q00999_T1Tutorial(int questId, String name, String descr)
	{
		...
		/*
		 * Talks.put(30017, new Talk(0, new String[]{"30017-01.htm", "30017-02.htm", "30017-04.htm"}, 0, 0)); Talks.put(30008, new Talk(0, new String[]{"30008-01.htm", "30008-02.htm", "30008-04.htm"}, 0, 0)); Talks.put(30370, new Talk(1, new String[]{"30370-01.htm", "30370-02.htm", "30370-04.htm"},
		 * 0, 0)); Talks.put(30129, new Talk(2, new String[]{"30129-01.htm", "30129-02.htm", "30129-04.htm"}, 0, 0)); Talks.put(30573, new Talk(3, new String[]{"30573-01.htm", "30573-02.htm", "30573-04.htm"}, 0, 0)); Talks.put(30528, new Talk(4, new String[]{"30528-01.htm", "30528-02.htm",
		 * "30528-04.htm"}, 0, 0)); Talks.put(30018, new Talk(0, new String[]{"30131-01.htm", "", "30019-03a.htm", "30019-04.htm",}, 1, RECOMMENDATION_02)); Talks.put(30019, new Talk(0, new String[]{"30131-01.htm", "", "30019-03a.htm", "30019-04.htm",}, 1, RECOMMENDATION_02)); Talks.put(30020, new
		 * Talk(0, new String[]{"30131-01.htm", "", "30019-03a.htm", "30019-04.htm",}, 1, RECOMMENDATION_02)); Talks.put(30021, new Talk(0, new String[]{"30131-01.htm", "", "30019-03a.htm", "30019-04.htm",}, 1, RECOMMENDATION_02)); Talks.put(30009, new Talk(0, new String[]{"30530-01.htm",
		 * "30009-03.htm", "", "30009-04.htm",}, 1, RECOMMENDATION_01)); Talks.put(30011, new Talk(0, new String[]{"30530-01.htm", "30009-03.htm", "", "30009-04.htm",}, 1, RECOMMENDATION_01)); Talks.put(30012, new Talk(0, new String[]{"30530-01.htm", "30009-03.htm", "", "30009-04.htm",}, 1,
		 * RECOMMENDATION_01)); Talks.put(30056, new Talk(0, new String[]{"30530-01.htm", "30009-03.htm", "", "30009-04.htm",}, 1, RECOMMENDATION_01)); Talks.put(30400, new Talk(1, new String[]{"30131-01.htm", "30400-03.htm", "30400-03a.htm", "30400-04.htm",}, 1, LEAF_OF_MOTHERTREE));
		 * Talks.put(30401, new Talk(1, new String[]{"30131-01.htm", "30400-03.htm", "30400-03a.htm", "30400-04.htm",}, 1, LEAF_OF_MOTHERTREE)); Talks.put(30402, new Talk(1, new String[]{"30131-01.htm", "30400-03.htm", "30400-03a.htm", "30400-04.htm",}, 1, LEAF_OF_MOTHERTREE)); Talks.put(30403, new
		 * Talk(1, new String[]{"30131-01.htm", "30400-03.htm", "30400-03a.htm", "30400-04.htm",}, 1, LEAF_OF_MOTHERTREE)); Talks.put(30131, new Talk(2, new String[]{"30131-01.htm", "30131-03.htm", "30131-03a.htm", "30131-04.htm",}, 1, BLOOD_OF_JUNDIN)); Talks.put(30404, new Talk(2, new
		 * String[]{"30131-01.htm", "30131-03.htm", "30131-03a.htm", "30131-04.htm",}, 1, BLOOD_OF_JUNDIN)); Talks.put(30574, new Talk(3, new String[]{"30575-01.htm", "30575-03.htm", "30575-03a.htm", "30575-04.htm",}, 1, VOUCHER_OF_FLAME)); Talks.put(30575, new Talk(3, new String[]{"30575-01.htm",
		 * "30575-03.htm", "30575-03a.htm", "30575-04.htm",}, 1, VOUCHER_OF_FLAME)); Talks.put(30530, new Talk(4, new String[]{"30530-01.htm", "30530-03.htm", "", "30530-04.htm",}, 1, LICENSE_OF_MINER)); Talks.put(32133, new Talk(5, new String[]{"32133-01.htm", "32133-02.htm", "32133-04.htm"}, 0,
		 * 0)); Talks.put(32134, new Talk(5, new String[]{"32134-01.htm", "32134-03.htm", "", "32134-04.htm",}, 1, DIPLOMA));
		 */
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if (Ex <= 2 && st.getQuestItemsCount(BLUE_GEM) < 1)
		{
			...
			{
				((L2MonsterInstance) npc).dropItem(st.getPlayer(), BLUE_GEM, 1);
				st.playSound("ItemSound.quest_tutorial");
			}
		}
		return null;
	...
	{
		new Q00999_T1Tutorial(999, Q00999_T1Tutorial.class.getSimpleName(), "");
	}
}