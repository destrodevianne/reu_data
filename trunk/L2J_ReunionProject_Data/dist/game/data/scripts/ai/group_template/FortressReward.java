...
public class FortressReward extends Quest
{
	...
	private static final int[] ARCHER_DROP =
	{
		4,
		16,
		71
	...
	private static final int[] ARCHCAP_DROP =
	{
		140,
		300,
		84
	...
	private static final int[] CGUARD_DROP =
	{
		4,
		12,
		66
	...
	private static final int[] DECORATED_DROP =
	{
		4,
		16,
		78
	...
	private static final int[] DGSERG_DROP =
	{
		4,
		12,
		61
	};
	private static final int[] SNOOP =
	{
		35711,
		36056,
		36094,
	...
	private static final int[] SNOOP_DROP =
	{
		24,
		72,
		2
	...
	private static final int[] GENERAL_DROP =
	{
		40,
		154,
		70
	...
	private static final int[] GUARD_DROP =
	{
		4,
		12,
		66
	};
	private static final int[] EVILUS =
	{
		36198,
		36236,
		36274,
	...
	private static final int[] EVILUS_DROP =
	{
		4,
		16,
		73
	...
	private static final int[] GUARDCAP_DROP =
	{
		140,
		300,
		84
	...
	private static final int[] HEALER_DROP =
	{
		4,
		16,
		82
	};
	private static final int[] MINISTER =
	{
		36205,
		36243,
		36281,
	...
	private static final int[] MINISTER_DROP =
	{
		40,
		154,
		70
	...
	private static final int[] REBELCOM_DROP =
	{
		40,
		200,
		90
	...
	private static final int[] REBELPRIV_DROP =
	{
		4,
		12,
		72
	...
	private static final int[] SGOLEM_DROP =
	{
		4,
		6,
		46
	...
	private static final int[] SBOX_DROP =
	{
		40,
		80,
		100
	};
	private static final int[] COURT =
	{
		35834
	};
	private static final int[] COURT_DROP =
	{
		240,
		480,
		100
	};
	private static final int[] FORT =
	{
		35803
	};
	private static final int[] FORT_DROP =
	{
		200,
		400,
		100
	};
	private static final int[] BOMB =
	{
		35766
	};
	private static final int[] BOMB_DROP =
	{
		160,
		320,
		100
	};
	private static final int[] BOOM =
	{
		35734
	};
	private static final int[] BOOM_DROP =
	{
		120,
		240,
		100
	};
	private static final int[] GANG =
	{
		35697
	};
	private static final int[] GANG_DROP =
	{
		80,
		160,
		100
	...
	private static final int[] SUPPORT_DROP =
	{
		140,
		300,
		84
	...
	private static final int[] WIZARD_DROP =
	{
		4,
		16,
		77
	...
	private void rewardPlayer(L2PcInstance player, L2Npc npc, int[] drop)
	{
		...
		if (Rnd.get(100) < chance)
		{
			if (player.isPremium())
			{
				st.giveItems(KE, (long) (Rnd.get(drop[0], drop[1]) * PremiumServiceConfigs.PREMIUM_RATE_DROP_ITEMS));
