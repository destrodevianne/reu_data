...
import l2r.gameserver.model.skills.funcs.FuncGet;
...
public class HeartA extends Quest
{
	...
	public HeartA(int questId, String name, String descr)
	{
	...
	{
		new HeartA(-1, HeartA.class.getSimpleName(), "instances");
	}
}